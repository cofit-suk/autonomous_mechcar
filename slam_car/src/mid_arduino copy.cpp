...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    ros::Publisher pub1 = nh.advertise<std_msgs::Int16>("R_motor_PWM", 10);
    //ros::Publisher pub2 = nh.advertise<geometry_msgs::Twist>("/cmd_vel",10);
    ros::Publisher pub3 = nh.advertise<std_msgs::Int16>("L_motor_PWM", 10);
    std_msgs::Int16 R_speed_msg;
    std_msgs::Int16 L_speed_msg;
    ...
    while(ros::ok())
    {
        ...
        // {
        //     R_speed_msg.data = 200;
        //     L_speed_msg.data = 200;
        // }
        ...
        // {
        //     R_speed_msg.data = 100;
        //     L_speed_msg.data = -100;
        // }
        // else if(linear_vel_data == 0 && angular_vel_data == -100)
        // {
        //     R_speed_msg.data = -100;
        ...
        //     L_speed_msg.data = 0;
        // }
        ROS_INFO("R_speed_msg = %d",R_speed_msg.data);
        ROS_INFO("L_speed_msg = %d",L_speed_msg.data);
        msg2.linear.x=0.5; 
        msg2.linear.y=0.0;
        ...
        pub1.publish(R_speed_msg);
        pub3.publish(L_speed_msg);
        ros::spinOnce();
        loop_rate.sleep();
    }
